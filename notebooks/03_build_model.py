...
# File: notebooks/03_build_model.py
...
sample_result = predict_heart_disease(
    age=54, sex=1, cp=2, trestbps=140, chol=239, fbs=0, restecg=1,
    thalach=160, exang=0, oldpeak=1.2, slope=2, ca=0, thal=2
)

print("\nSample prediction:")
print(f"Prediction: {sample_result['prediction']}")
print(f"Disease probability: {sample_result['probability_disease']:.3f}")